...
interface HRConsoleViewProps {
  currentUser: string;
  onLogout: () => void;
}

export const HRConsoleView: React.FC<HRConsoleViewProps> = ({ currentUser, onLogout }) => {
  ...
  const handleSendToManager = (candId: string) => {
    ...
    showToast('Candidate successfully dispatched to Manager Review Room!');
  };
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#d9c6d1]">
                Logged in as: <span className="text-[#FA1E71] font-semibold font-mono">{currentUser}</span> • Pipeline Control & Sourcing
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        ...
        <div className="flex flex-wrap gap-2 border-b border-white/10 pb-4 mb-6">
          ...
          >
            ...
            <span>Neural Sourcing Parameters</span>
          </button>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-between">
                ...
                <div className="flex items-center gap-3 text-xs">
                  ...
                  <div className="px-3.5 py-2 bg-[#FA1E71]/15 text-[#FA1E71] rounded-xl border border-[#FA1E71]/30 font-semibold">
                    <span>Active Threshold: {similarityThreshold}%</span>
                  </div>
                </div>
              </div>
